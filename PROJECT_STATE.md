...
| 2026-09-02 | Koyeb live deployment status | Deployment 575ea432 (commit de970f3) built & HEALTHY |

The local runtime, Turso initialization, one fixed-process scheduled Reddit sticker delivery, and one isolated direct Reddit generation/send were verified. Discovery now targets multiple meme/comedy subreddits, rejects removed/deleted/generic shell results, rejects known over-limit videos, and scheduled delivery also skips historical photo-only rows. Koyeb deployment 575ea432 is running healthy on commit de970f3 with !sgif routing fix.
...
| Limitation | Status |
|---|---|
| Koyeb deployment health after this migration | Verified healthy (deployment 575ea432 on commit de970f3) |
